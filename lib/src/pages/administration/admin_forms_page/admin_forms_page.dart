...
import 'package:isati_integration/src/pages/administration/admin_forms_page/admin_form_page/admin_form_page.dart';
...
class AdminFormsPage extends StatefulWidget {
  ...
  @override
  _AdminFormsPageState createState() => _AdminFormsPageState();
}
    ...
    await Navigator.of(context).push<void>(
      MaterialPageRoute(
        builder: (context) => ChangeNotifierProvider.value(
          value: userStore,
          builder: (context, child) => AdminFormPage()
        ),
      )
    );
  }
